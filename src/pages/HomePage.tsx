...
const parts = [
  {
    title: 'Part 1 · 基础篇',
    description: '从光波物理量到半导体能带、PN 结与光电器件，建立光电子学物理基础',
    modules: [
      {
        title: '光波基础与物理量',
      ...
      {
        title: '晶体结构与缺陷',
        description: '晶格、晶向、晶体缺陷及其对光电器件性能的影响。',
        icon: <Boxes className="w-7 h-7" />,
        color: '#06b6d4',
        path: ROUTES.LEARN.CRYSTAL_STRUCTURE,
      },
      {
        title: '半导体基础',
        description: '能带结构、本征与掺杂半导体、费米能级及载流子输运。',
        icon: <Atom className="w-7 h-7" />,
        color: '#00ff88',
        path: ROUTES.LEARN.SEMICONDUCTOR_BASICS,
      },
      {
        title: 'PN 结基础',
        description: 'PN 结形成、内建电场、能带图与整流特性。',
        icon: <GitMerge className="w-7 h-7" />,
        color: '#f59e0b',
        path: ROUTES.LEARN.PN_JUNCTION_BASICS,
      },
      {
        title: '载流子复合机制',
        description: '辐射复合、SRH 复合与俄歇复合，少子寿命与器件性能。',
        icon: <Merge className="w-7 h-7" />,
        color: '#a855f7',
        path: ROUTES.LEARN.RECOMBINATION,
      },
      {
        title: '光与物质相互作用',
        description: '受激吸收与辐射、粒子数反转与增益，激光的物理基础。',
        icon: <Sun className="w-7 h-7" />,
        color: '#ff3366',
        path: ROUTES.LEARN.LIGHT_MATTER_INTERACTION,
      },
      {
        title: '异质结与能带对准',
        description: '同质结与异质结、能带对准类型及载流子/光场限制。',
        icon: <Layers2 className="w-7 h-7" />,
        color: '#22c55e',
        path: ROUTES.LEARN.HETEROJUNCTION,
      },
      {
        title: '半导体基本方程',
        description: '泊松方程、连续性方程与漂移扩散方程的耦合求解。',
        icon: <Sigma className="w-7 h-7" />,
        color: '#06b6d4',
        path: ROUTES.LEARN.SEMICONDUCTOR_EQUATIONS,
      },
      {
        title: 'PN 结进阶：暗电流与耗尽区分析',
        description: '耗尽区宽度与电容、暗电流组成及其温度依赖。',
        icon: <Microscope className="w-7 h-7" />,
        color: '#f59e0b',
        path: ROUTES.LEARN.PN_JUNCTION_ADVANCED,
      },
      {
        title: '光电效应与光电器件',
        description: '光电效应、光电二极管与电光/非线性光学材料。',
