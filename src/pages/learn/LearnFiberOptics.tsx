...
export default function LearnFiberOptics() {
  const { currentIndex, totalChapters, prevChapter, nextChapter, IconPrev, IconNext } = useChapterNavigation(ROUTES.LEARN.FIBER_OPTICS);
    ...
    >
      <LearnSection id="s-0" icon={<Waves className="w-5 h-5 text-laser-cyan" />} title="光纤的结构与原理">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            光纤（Optical Fiber）是光通信系统的传输介质，由高纯度的石英玻璃制成。
            典型的光纤由三层结构组成：最内层的<span className="text-laser-cyan font-semibold">纤芯（Core）</span>、
            中间层的<span className="text-laser-green font-semibold">包层（Cladding）</span>和
            最外层的<span className="text-laser-purple font-semibold">涂覆层（Coating）</span>。
          ...
          <p>
            光纤导光的核心物理机制是<span className="text-laser-cyan font-semibold"><TermNote term="全内反射" />（Total Internal Reflection, TIR）</span>。
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <p className="text-sm mb-3">
              <TermNote term="数值孔径" />（NA）是衡量光纤集光能力的关键参数，定义为光纤所能接收的光锥角的正弦值：
            </p>
            <MathRenderer>{'$$\\text{NA} = \\sin\\theta_a = \\sqrt{n_1^2 - n_2^2} \\approx n_1\\sqrt{2\\Delta}$$'}</MathRenderer>
            <div className="grid md:grid-cols-2 gap-4 mt-3 text-xs">
              <div className="space-y-1">
                <p><span className="text-laser-cyan font-mono">θ_a</span> — 接收角（最大入射角）</p>
                <p><span className="text-laser-green font-mono">n₁</span> — 纤芯折射率</p>
              </div>
              <div className="space-y-1">
                <p><span className="text-laser-purple font-mono">n₂</span> — 包层折射率</p>
                <p><span className="text-laser-red font-mono">Δ</span> — 相对折射率差 (n₁−n₂)/n₁</p>
              </div>
            </div>
            <p className="text-sm mt-3">
              单模光纤的 NA 通常约为 0.12（接收角约 6.9°），多模光纤的 NA 约为 0.27（接收角约 15.7°）。
              NA 越大，光纤收集光的能力越强，但也会导致更大的模间色散。
            </p>
          </div>
        </div>
      </LearnSection>
      ...
      <LearnSection id="s-1" icon={<Cable className="w-5 h-5 text-laser-purple" />} title="单模光纤与多模光纤">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            根据纤芯中允许传播的电磁模式数量，光纤可分为<span className="text-laser-purple font-semibold">单模光纤（SMF）</span>
            和<span className="text-laser-cyan font-semibold">多模光纤（MMF）</span>两大类。
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border border-laser-purple/30 bg-laser-purple/5 p-4 rounded-xl">
              ...
              <ul className="text-sm space-y-2">
                <li><span className="text-laser-purple">•</span> 纤芯直径：8-10 μm</li>
                <li><span className="text-laser-purple">•</span> 包层直径：125 μm（标准）</li>
                <li><span className="text-laser-purple">•</span> 工作波长：1310 nm / 1550 nm</li>
                <li><span className="text-laser-purple">•</span> 无模间色散，带宽极大</li>
                <li><span className="text-laser-purple">•</span> 长距离传输（40-100+ km）</li>
              </ul>
            </div>
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              ...
              <ul className="text-sm space-y-2">
                <li><span className="text-laser-cyan">•</span> 纤芯直径：50 μm 或 62.5 μm</li>
                <li><span className="text-laser-cyan">•</span> 包层直径：125 μm（标准）</li>
                <li><span className="text-laser-cyan">•</span> 工作波长：850 nm / 1300 nm</li>
                <li><span className="text-laser-cyan">•</span> 模间色散限制带宽</li>
                <li><span className="text-laser-cyan">•</span> 短距离传输（百米级）</li>
              </ul>
            </div>
          </div>
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <p className="text-sm mb-3">
              ...
              <span className="text-laser-purple font-semibold"><TermNote term="模场直径" />（Mode Field Diameter, MFD）</span>
            ...
            <p className="text-sm mt-3">
              实际工程中常用的单模光纤标准包括 G.652（标准单模光纤）、G.655（非零色散位移光纤）
              和 G.657（抗弯曲光纤），它们针对不同应用场景进行了优化。
            </p>
          </div>
        </div>
      </LearnSection>
      ...
      <LearnSection id="s-2" icon={<BarChart3 className="w-5 h-5 text-laser-red" />} title="光纤损耗">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            光信号在光纤中传播时，功率会随距离指数衰减，这一现象称为<span className="text-laser-red font-semibold">光纤损耗</span>。
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-lab-bg/50 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-cyan mb-2"><TermNote term="瑞利散射" /></h4>
              <p className="text-sm">
                光纤制造过程中玻璃密度不均匀引起的微观折射率波动，使光向各个方向散射。
            ...
            <div className="bg-lab-bg/50 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-green mb-2"><TermNote term="吸收损耗" /></h4>
              <p className="text-sm">
                包括紫外吸收（电子跃迁）、红外吸收（分子振动）和 OH⁻ 杂质吸收。
                现代光纤通过去除水分（干燥工艺）已将 OH⁻ 吸收峰大幅抑制。
              </p>
            </div>
            <div className="bg-lab-bg/50 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-purple mb-2">弯曲损耗</h4>
              <p className="text-sm">
                光纤弯曲时，全内反射条件被破坏，部分光会泄漏出纤芯。
                分为宏弯损耗（大半径弯曲）和微弯损耗（微小形变）。
                抗弯曲光纤（G.657）对此进行了优化。
              </p>
            </div>
          </div>
      ...
      <LearnSection id="s-3" icon={<GitFork className="w-5 h-5 text-laser-green" />} title="色度色散">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            <span className="text-laser-green font-semibold"><TermNote term="色度色散" />（Chromatic Dispersion, CD）</span>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-cyan mb-2"><TermNote term="材料色散" /></h4>
              <p className="text-sm">
            ...
            <div className="border border-laser-purple/30 bg-laser-purple/5 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-purple mb-2"><TermNote term="波导色散" /></h4>
              <p className="text-sm">
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <p className="text-sm mb-3">
              色散系数 D 随波长变化，其变化率称为<span className="text-laser-green font-semibold">色散斜率（Dispersion Slope, S）</span>。
              对于 G.652 光纤，零色散波长 λ₀ 约为 1310 nm，在此波长处 D = 0：
            </p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-lab-surface/50 p-3 rounded-lg">
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-3 rounded-lg">
                <h5 className="font-semibold text-laser-cyan text-sm mb-1"><TermNote term="色散补偿光纤" /> (DCF)</h5>
                <p className="text-xs">
                  具有负色散系数的特种光纤（D ≈ −80 至 −100 ps/(nm·km)），
                  串联在传输链路中抵消正色散。
                </p>
              </div>
              ...
              <div className="border border-laser-green/30 bg-laser-green/5 p-3 rounded-lg">
                ...
                <p className="text-xs">
                  在相干接收系统的 DSP 中通过 FIR 滤波器或频域均衡进行色散补偿，
                  灵活且不需要额外光学器件。
                </p>
              </div>
            </div>
      ...
      <LearnSection id="s-4" icon={<Zap className="w-5 h-5 text-amber-400" />} title="非线性效应">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            ...
            <span className="text-amber-400 font-semibold"><TermNote term="非线性效应" /></span>。
            折射率与光强的依赖关系可表示为：
          </p>
          <div className="bg-lab-bg/50 px-4 py-3 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="border border-amber-400/30 bg-amber-400/5 p-4 rounded-xl">
              <h4 className="font-semibold text-amber-400 mb-2"><TermNote term="自相位调制" /> (SPM)</h4>
              ...
              <p className="text-xs text-lab-muted mt-2">
                SPM 与色散相互作用——在反常色散区（1550 nm），SPM 引起的啁啾与色散效果相反，
                可实现孤子传输。
              </p>
            </div>
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-cyan mb-2"><TermNote term="交叉相位调制" /> (XPM)</h4>
              <p className="text-sm mb-2">
                一个波长信道的光强变化通过克尔效应影响另一共存信道的相位。
            ...
            <div className="border border-laser-purple/30 bg-laser-purple/5 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-purple mb-2"><TermNote term="四波混频" /> (FWM)</h4>
              <p className="text-sm mb-2">
                三个频率的光在光纤中相互作用产生第四个频率的新光。
              ...
              <p className="text-xs text-lab-muted mt-2">
                色散的存在会破坏相位匹配条件从而抑制 FWM 效率。
                这就是 G.655（非零色散位移光纤）在零色散点引入少量色散的原因。
              </p>
            </div>
          </div>
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-lab-surface/50 p-3 rounded-lg">
                ...
                <p className="text-xs">
                  大有效面积光纤（如 G.654）通过增大 A_eff 降低 γ，
                  从而抑制所有非线性效应的强度。
                </p>
              </div>
              <div className="bg-lab-surface/50 p-3 rounded-lg">
                ...
                <p className="text-xs">
                  在相干接收系统的 DSP 中，使用数字反向传播（DBP）算法
                  对传输链路的非线性损伤进行数值补偿。
                </p>
              </div>
            </div>
      ...
      <LearnSection id="s-5" icon={<Compass className="w-5 h-5 text-laser-orange" />} title="保偏光纤">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            标准单模光纤的纤芯是完美圆对称的，因此两个正交偏振模式（LP₀₁ˣ 和 LP₀₁ʸ）具有相同的传播常数，
            即它们是<span className="text-laser-orange font-semibold">简并</span>的。
            然而，实际光纤中的微小应力或几何不完美会引入随机的双折射，使光在传输过程中偏振态发生不可控的变化。
          </p>
          <p>
            <span className="text-laser-orange font-semibold"><TermNote term="保偏光纤" />（Polarization-Maintaining Fiber, PMF）</span>
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <p className="text-sm mt-3">
              ...
              它们的共同特点是在纤芯两侧引入应力施加区，利用热膨胀系数差异产生各向异性应力，
              从而形成强双折射。
            </p>
          </div>
          <div className="bg-lab-bg/50 p-5 rounded-xl">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
                ...
                <p className="text-xs">
                  利用萨格纳克（Sagnac）效应测量旋转角速度。
                  PMF 确保了干涉仪中两束光的偏振态一致，是实现高精度导航级光纤陀螺的关键器件。
                </p>
              </div>
          ...
          <p>
            ...
            如果入射光的偏振态没有精确对准 PMF 的主轴，两个模式都会被激发，反而会产生偏振拍动。
            因此，PMF 的连接和熔接需要精密的偏振对准。
          </p>
        </div>
      </LearnSection>
    </LearnLayout>
