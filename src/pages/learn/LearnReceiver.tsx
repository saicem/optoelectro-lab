  ...
  return (
    ...
    >
      <LearnSection id="s-0" icon={<Radio className="w-5 h-5 text-laser-green" />} title="光电效应与光电二极管">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="bg-lab-bg/50 px-4 py-3 rounded-lg">
            ...
            <p className="text-sm mt-2">其中 E_g 是半导体的禁带宽度。光子能量必须大于禁带宽度才能产生光电效应。</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 mt-4">
            <div>
              <h3 className="font-semibold text-lab-text mb-2">
                <TermNote term="PIN 光电二极管" />：
              </h3>
              <p className="text-sm">
            ...
            <div>
              <h3 className="font-semibold text-lab-text mb-2">
                <TermNote term="APD 雪崩光电二极管" />：
              </h3>
              <p className="text-sm">
                APD 利用雪崩倍增效应，使光生载流子在强电场下获得足够高的能量，
                通过碰撞电离产生更多的载流子，从而实现内部增益。
              </p>
              <p className="text-sm mt-2">APD 灵敏度更高，但需要较高的反向偏置电压，且噪声较大。</p>
            </div>
          </div>
        </div>
      </LearnSection>
        ...
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              ...
              <div className="mt-3 text-xs text-lab-muted">典型应用：10G EPON、数据中心短距互联</div>
            </div>
            <div className="border border-laser-purple/30 bg-laser-purple/5 p-4 rounded-xl">
              ...
              <p className="text-sm">
                相干检测使用 <TermNote term="本振光" />
                与信号光混频，可以同时检测光的幅度、相位和偏振态。 灵敏度高、频谱效率高，是长距离高速光通信的主流方案。
              </p>
              <div className="mt-3 text-xs text-lab-muted">典型应用：100G/400G/800G 长距传输</div>
            </div>
          </div>
          <p className="mt-4">
            ...
            <div className="text-xs space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto mt-2">
                <div className="text-center">
                  ...
                  <div className="px-2 py-1 border border-laser-green/50 rounded bg-laser-green/10 text-xs">
                    90° 光混频器
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-laser-red text-xs mb-1">Y 偏振</div>
                  <div className="px-2 py-1 border border-laser-red/50 rounded bg-laser-red/10 text-xs">
                    90° 光混频器
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  将模拟电信号转换为数字信号，以便后续进行数字信号处理。 ADC
                  的采样率和比特数是决定接收机性能的关键参数。
                </p>
              </div>
            </div>
          </div>
      ...
      <LearnSection id="s-3" title="接收机噪声分析">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>光接收机的性能极限主要受噪声影响。了解噪声来源对于理解灵敏度限制至关重要。</p>
          <div className="grid md:grid-cols-3 gap-4 mt-4">
            <div className="border border-laser-cyan/30 bg-laser-cyan/5 p-4 rounded-xl">
              <h4 className="font-semibold text-laser-cyan mb-2">散粒噪声 (Shot Noise)</h4>
              <p className="text-sm mb-2">由光子到达的随机性产生。每个光子产生的电子-空穴对数目具有统计波动。</p>
              <div className="bg-lab-bg/50 px-3 py-2 rounded-lg text-xs">
                <MathRenderer>{'$$\\langle i_s^2 \\rangle = 2e I B$$'}</MathRenderer>
              </div>
              <p className="text-xs text-lab-muted mt-2">e 是电子电荷，I 是平均光电流，B 是带宽。</p>
            </div>
            <div className="border border-laser-green/30 bg-laser-green/5 p-4 rounded-xl">
              ...
              <p className="text-sm mb-2">由接收电路中载流子的热运动产生。与温度成正比，与光功率无关。</p>
              <div className="bg-lab-bg/50 px-3 py-2 rounded-lg text-xs">
                <MathRenderer>{'$$\\langle i_T^2 \\rangle = \\frac{4kTB}{R}$$'}</MathRenderer>
              </div>
              <p className="text-xs text-lab-muted mt-2">k 是玻尔兹曼常数，T 是温度，R 是负载电阻。</p>
            </div>
            <div className="border border-laser-purple/30 bg-laser-purple/5 p-4 rounded-xl">
          ...
          <div className="border border-amber-500/30 bg-amber-500/5 p-4 rounded-xl mt-4">
            ...
            <p className="text-sm mt-2">
              ASE 噪声与信号光在光电检测中会产生两种差拍噪声：
              <strong className="text-lab-text">信号-ASE 差拍噪声</strong>和
              <strong className="text-lab-text">ASE-ASE 差拍噪声</strong>。 前者正比于信号光功率 × ASE 功率谱密度，是
              ASE 受限系统中的主要噪声源。
            </p>
          </div>
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl mt-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-lab-surface/50 p-3 rounded-lg">
                ...
                <p className="text-xs text-lab-muted mt-2">对于相干接收，主要受散粒噪声限制（本振光功率足够大时）。</p>
              </div>
              <div className="bg-lab-surface/50 p-3 rounded-lg">
                ...
                <p className="text-xs text-lab-muted mt-2">Q 值由目标 BER 决定（BER = 10⁻¹² → Q ≈ 7）。</p>
              </div>
            </div>
          </div>
      ...
      <LearnSection id="s-4" title="数字信号处理 (DSP)">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            现代相干光通信系统中，大部分信号处理工作都在数字域完成。 DSP
            芯片是接收机的"大脑"，负责补偿各种传输损伤，恢复原始数据。
          </p>
          ...
          <div className="bg-lab-bg/50 p-4 rounded-xl mt-4">
            ...
            <p className="text-sm">
              偏振解复用通常使用自适应均衡算法来实现。<strong className="text-lab-text">恒模算法 (CMA)</strong> 适用于
              QPSK 等恒模信号， 通过最小化输出模值误差来分离两个偏振态；
              <strong className="text-lab-text">多模算法 (MMA)</strong> 则是 CMA 在高阶 QAM 场景的扩展，
              在多个模值层间进行判决导向均衡。两者的核心差异在于 CMA 使用单一的目标模值 R²，而 MMA
              根据符号的判决结果动态选择目标模值。 实际系统中，CMA
              常用于收敛阶段，随后切换为判决导向模式以获得更优的均衡效果。
            </p>
          </div>
      ...
      <LearnSection id="s-5" title="接收机性能指标">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="bg-lab-bg/50 p-5 rounded-xl mt-4">
            ...
            <p className="text-sm mb-3">功率预算用于验证链路端到端的光功率是否满足接收灵敏度要求。基本公式为：</p>
            ...
            <p className="text-sm mb-3">以 80 km 传输链路为例：</p>
            <div className="bg-lab-surface/50 p-3 rounded-lg text-xs space-y-1">
              <p>
                <strong className="text-laser-cyan">发射功率：</strong> P<sub>tx</sub> = 0 dBm
              </p>
              <p>
                <strong className="text-laser-green">光纤损耗：</strong> 0.2 dB/km × 80 km = 16 dB
              </p>
              <p>
                <strong className="text-laser-purple">连接器 + 接头损耗：</strong> 约 2 dB
              </p>
              <p>
                <strong className="text-amber-500">EDFA 增益：</strong> 每 80 km 放大 16 dB（补偿光纤损耗）
              </p>
              <p className="pt-1 border-t border-lab-border/30">
                <strong className="text-lab-text">接收功率：</strong> P<sub>rx</sub> = 0 - 16 - 2 + 16 ={' '}
                <strong className="text-laser-green">-2 dBm</strong>
              </p>
            </div>
      ...
      <LearnSection id="s-6" title="总结：完整的光通信系统">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>至此，我们已经学习了一个完整光通信系统的各个组成部分：</p>
          <div className="bg-lab-bg/50 p-5 rounded-xl">
          ...
          <p>
            ...
            最后由接收机检测并恢复数据——这就是一个完整的光通信链路。 其中，<strong>DP-IQ 调制器 + 相干接收</strong>{' '}
            的组合， 是当前高速光通信系统中频谱效率最高、应用最广泛的方案。
          </p>
          ...
          <p className="text-center mt-6">
            ...
            <br />
            <span className="text-sm text-lab-muted">现在去 Playground 动手实验，巩固所学知识吧！</span>
          </p>
        </div>
      </LearnSection>
    </LearnLayout>
