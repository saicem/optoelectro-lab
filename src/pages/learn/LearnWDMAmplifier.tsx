import { Network, GitBranch, CircuitBoard, Zap, Gauge, Cable, Radio } from 'lucide-react';
    ...
    >
      <LearnSection id="s-0" icon={<Network className="w-5 h-5 text-laser-cyan" />} title="WDM 波分复用基本原理">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            <span className="text-laser-cyan font-semibold"><TermNote term="WDM" /></span>
            的核心思想非常直观：在一根光纤中同时传输多个不同波长的光信号，每个波长承载独立的数据流。
            就像在一条公路上划分多条车道，WDM 将光纤的宽广光学带宽划分为若干独立的信道。
          </p>
          <p>
            光通信的容量增长史，本质上就是 WDM 信道数量的增长史。
            单根光纤的总传输容量由以下公式决定：
          </p>
          ...
          <p>
            其中 N 为波长信道数，C_channel 为单波长承载的比特率。
            在 WDM 技术出现之前，单纤仅能传输一个波长的信号；而现代商用 WDM 系统可在一根光纤中同时传输
            80-160 个波长，配合每波长 400G/800G 的调制速率，单纤容量已达数十 Tb/s 量级。
          </p>
      ...
      <LearnSection id="s-1" icon={<GitBranch className="w-5 h-5 text-laser-cyan" />} title="ITU-T 波长栅格">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="bg-lab-bg/40 p-4 rounded-lg">
            <MathRenderer>{'$$\\Delta f = 100\\,\\text{GHz} \\approx 0.8\\,\\text{nm} \\quad (\\text{C 波段, 1550 nm})$$'}</MathRenderer>
            <MathRenderer>{'$$\\Delta f = 50\\,\\text{GHz} \\approx 0.4\\,\\text{nm} \\quad (\\text{更高的频谱效率})$$'}</MathRenderer>
          </div>
          ...
          <p>
            ...
            其他信道频率按固定间隔向两侧扩展。例如，100 GHz 栅格的系统信道频率为
            193.1 ± N × 0.1 THz（N 为整数）。50 GHz 栅格则将间隔减半，信道数翻倍。
          </p>
      ...
      <LearnSection id="s-2" icon={<CircuitBoard className="w-5 h-5 text-laser-cyan" />} title="复用/解复用器件">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-2">
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-cyan/20">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>基于平面光波导 (PLC) 技术集成制造</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>工作原理类似衍射光栅：不同波长经波导阵列后产生不同的相位延迟，在输出端空间分离</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>支持 50 GHz / 25 GHz 间隔，信道数可达 64-128 个</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-red">•</span><span>典型插损 3-6 dB，串扰 &lt; -25 dB</span></li>
              </ul>
            </div>
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-purple/20">
              <h4 className="font-semibold text-laser-purple mb-2">薄膜滤波器 (TFF)</h4>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>利用多层介质膜干涉效应实现波长选择</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>通过级联多个 TFF 组成复用/解复用模块</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>通带平坦、通道隔离度好</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-red">•</span><span>信道数较多时体积大、成本高</span></li>
              </ul>
            </div>
          </div>
          <p>
          ...
          <div className="bg-lab-bg/40 p-4 rounded-lg">
            <MathRenderer>{'$$\\Delta \\theta = \\frac{2\\pi n \\Delta L}{\\lambda} \\quad \\text{(相邻波导间的相位差)}$$'}</MathRenderer>
      ...
      <LearnSection id="s-3" icon={<Zap className="w-5 h-5 text-laser-cyan" />} title="EDFA 掺铒光纤放大器">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            <span className="text-laser-cyan font-semibold"><TermNote term="EDFA" /></span>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-2">
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-cyan/20">
              ...
              <p className="text-sm">掺铒光纤中的 Er³⁺ 离子被 980 nm 或 1480 nm 泵浦激光激发到高能级，
              信号光通过时受激辐射产生放大</p>
            </div>
            ...
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-purple/20">
              ...
              <p className="text-sm">增益 20-40 dB，输出功率 +13 到 +23 dBm，<TermNote term="噪声系数" /> 4-6 dB</p>
            </div>
          </div>
          <div className="bg-lab-bg/40 p-4 rounded-lg mt-2">
            <h4 className="font-semibold text-lab-text mb-2">ASE 噪声与噪声系数</h4>
            <p className="mb-2">
              EDFA 在放大信号的同时会引入<TermNote term="ASE 噪声" />——铒离子的<TermNote term="自发辐射" />
              被放大后产生的宽带背景噪声。ASE 是限制 WDM 系统信噪比的根本因素。
            </p>
            <MathRenderer>{'$$NF = \\frac{SNR_{in}}{SNR_{out}} = 2n_{sp} + \\frac{1}{G} \\approx 2n_{sp}$$'}</MathRenderer>
            <p className="text-sm mt-1">
              其中 n_sp ≥ 1 是自发辐射因子，G 是增益。理想 EDFA 的 NF 极限为 3 dB（n_sp = 1）。
              实际商用 EDFA 的 NF 在 4-6 dB 范围内。
            </p>
          </div>
          <div className="bg-lab-bg/40 p-4 rounded-lg">
          ...
          <p>
            EDFA 的出现使得 WDM 长距离传输成为可能。在典型的陆地骨干网中，
            每 80-100 km 设置一个 EDFA 中继站，每一级 EDFA 同时放大多个波长信道。
            级联 EDFA 的噪声会累积，因此系统总长度受 OSNR 限制。
          </p>
        </div>
      </LearnSection>
      ...
      <LearnSection id="s-4" icon={<Gauge className="w-5 h-5 text-laser-cyan" />} title="拉曼放大器与系统方案">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            ...
            是另一种重要的光放大技术，它利用光纤本身的<TermNote term="非线性效应" />中的
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-2">
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-cyan/20">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>高功率泵浦光从光纤末端注入（反向泵浦），在整段光纤中产生分布式增益</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>信号沿光纤传输时被持续放大，等效于降低光纤的"有效损耗"</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>拉曼频移约 13 THz（石英光纤），泵浦波长通常比信号波长短约 100 nm</span></li>
              </ul>
            </div>
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-purple/20">
              <h4 className="font-semibold text-laser-purple mb-2">EDFA + 拉曼混合放大</h4>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>拉曼提供分布式增益改善 OSNR，EDFA 提供集中式高增益</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>可降低噪声系数约 2-4 dB，显著提升系统传输距离</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>超长距海底光缆和陆地骨干网广泛采用</span></li>
              </ul>
            </div>
          </div>
          <p>
            拉曼放大的核心优势在于其<strong>分布式特性</strong>：传统的 EDFA 是集中式放大，
            信号在到达 EDFA 之前已经被光纤损耗衰减到较低水平，导致接收 OSNR 下降。
            而分布式拉曼放大沿光纤全程提供增益，使信号功率始终维持在较高水平，
            从而显著改善系统的 OSNR 性能。
          </p>
          <div className="bg-lab-bg/40 p-4 rounded-lg">
            <MathRenderer>{'$$\\frac{dP_s}{dz} = -\\alpha_s P_s + g_R P_p P_s \\quad \\text{(拉曼放大耦合方程)}$$'}</MathRenderer>
            <p className="text-sm mt-2">
          ...
          <div className="bg-lab-surface/30 border border-laser-cyan/20 p-4 rounded-lg">
            <p className="text-sm">
              <strong>典型方案对比：</strong>纯 EDFA 方案适合 600-800 km 的陆地传输；
              EDFA + 拉曼混合方案可将距离扩展至 1500-2000 km；超长距海底光缆系统
              （如跨太平洋 6000-9000 km）则需综合使用拉曼放大、EDFA 和先进的编码调制技术。
            </p>
          </div>
        </div>
      </LearnSection>
      ...
      <LearnSection id="s-5" icon={<Cable className="w-5 h-5 text-laser-cyan" />} title="Flex-Grid 与弹性光网络">
        <div className="space-y-4 text-lab-muted leading-relaxed">
          <p>
            传统 WDM 系统使用<strong>固定栅格 (Fixed-Grid)</strong>——所有信道使用相同的、固定的信道间隔
            （如 50 GHz）。这种方式虽然实现简单，但频谱利用率不高：
            低速信道（如 100G QPSK）占用 50 GHz 带宽造成浪费，
            而高速信道（如 800G）可能需要超过 50 GHz 的带宽却无法扩展。
          </p>
          <p>
            <span className="text-laser-cyan font-semibold">Flex-Grid（弹性栅格）</span>
            是 ITU-T G.694.1 标准的新一代波长栅格方案。它将频谱划分为更细的粒度
            ——<strong>12.5 GHz 的频槽 (slot)</strong>，每个信道可以占用连续整数个频槽
            （如 2 个 = 25 GHz，4 个 = 50 GHz，6 个 = 75 GHz 等），实现信道带宽的按需分配。
          </p>
          <div className="grid md:grid-cols-2 gap-4 mt-2">
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-cyan/20">
              <h4 className="font-semibold text-laser-cyan mb-2">弹性光网络 (EON)</h4>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>带宽可变：每个信道分配与实际速率匹配的频谱宽度</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>频谱碎片管理：动态分配和回收频谱资源</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>软件定义光网络 (SDON)：通过控制平面实现灵活调度</span></li>
              </ul>
            </div>
            <div className="bg-lab-bg/40 p-4 rounded-xl border border-laser-purple/20">
              <h4 className="font-semibold text-laser-purple mb-2">频谱效率提升</h4>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2"><span className="text-laser-cyan">•</span><span>固定 50 GHz 栅格：400G 信号频谱效率 ~8 bit/s/Hz</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-green">•</span><span>Flex-Grid 37.5 GHz：400G DP-16QAM 频谱效率可提升至 ~10.7 bit/s/Hz</span></li>
                <li className="flex items-start gap-2"><span className="text-laser-purple">•</span><span>整体频谱利用率可提升 30-50%</span></li>
              </ul>
            </div>
          </div>
          <div className="bg-lab-bg/40 p-4 rounded-lg">
